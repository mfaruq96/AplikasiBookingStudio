...
Class model_orders extends CI_Model
{
	...
	public function update_where_id_user_id_order($update_total_price, $current_id_user, $current_id_order)
	{
		$data = [
	...
	public function delete_where_id($id_order, $update_total_price)
	{
		$data = [
			'total_price' => $update_total_price,
		];
