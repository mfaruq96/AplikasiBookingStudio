...
<div class="container-fluid mb-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?= base_url('orders/order_process'); ?>">Order Process</a></li>
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-4 text-gray-800">Order Process <?= $order['invoice']; ?></h1>
	<!-- End Page Heading -->
	...
	<div class="row mt-3">
		<div class="col-lg-12 mb-2 text-right">
			...
			<button class="btn btn-sm btn-success mb-2" width="100%" data-toggle="modal" data-target="#viewProcess">Done</button>
		</div>
	</div>
	<!-- end checkout -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<form action="<?= base_url('orders/order_process_verify/') . $order['id_order']; ?>" method="post">
