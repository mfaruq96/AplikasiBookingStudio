...
<div class="container-fluid mb-5">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?= base_url('orders/manual_orders'); ?>">Manual Orders</a></li>
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-4 text-gray-800">Manual Orders <?= $order_detail_try['name']; ?> <span class="badge badge-warning">belum bayar</span></h1>
	<!-- End Page Heading -->
